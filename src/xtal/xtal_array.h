...
public:
	...
	*
	*/
	const SmartPtr<T>& at(int_t i){
		return static_ptr_cast<T>(Array::at(i));
	}
	...
	*
	*/
	void set_at(int_t i, const SmartPtr<T>& v){
		Array::set_at(i, v);
	}
	...
	*
	*/
	const SmartPtr<T>& op_at(int_t i){
		return static_ptr_cast<T>(Array::op_at(i));
	}
	...
	*
	*/
	void op_set_at(int_t i, const SmartPtr<T>& v){
		Array::op_set_at(i, v);
	}
	...
	*
	*/
	void push_front(const SmartPtr<T>& v){
		Array::insert(0, v);
	}
	...
	*
	*/
	void push_back(const SmartPtr<T>& v){
		Array::push_back(v);
	}
	...
	*
	*/
	const SmartPtr<T>& front(){
		return static_ptr_cast<T>(Array::op_at(0));
	}
	...
	*
	*/
	const SmartPtr<T>& back(){
		return static_ptr_cast<T>(Array::op_at(size()-1));
	}
	...
	*
	*/
	void insert(int_t i, const SmartPtr<T>& v){
		Array::insert(i, v);
	}
};
