...
inline AnyPtr Any::send(const IDPtr& primary_key) const{
...
inline AnyPtr Any::send2(const IDPtr& primary_key, const AnyPtr& secondary_key) const{
	const VMachinePtr& vm = vmachine();
	vm->setup_call();
